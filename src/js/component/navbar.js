...
export const Navbar = () => {
	...
	return (
		<header>
			...
			<div className="divnavbar navbar navbar-dark bg-dark shadow-sm border-bottom border-primary">
				<div className="divnavbarconntainer col-12 d-flex mx-0 px-0 ">
					<button
					...
					<Link to="/" className="navbar-brand mx-auto pl-5">
